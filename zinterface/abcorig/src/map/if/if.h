...
extern void            If_CutNodesMerge( If_Cut_t * pCut0, If_Cut_t * pCut1, If_Cut_t * pCut );
extern void            If_CutFanoutVec( If_Man_t * p );
extern Vec_Ptr_t *     FaninCount( If_Man_t * p, Vec_Ptr_t * vNodesInCut );
...
extern float           If_MultiOutputCutArea( If_Man_t * p, If_Obj_t * pObj, If_Cut_t * pCut, float Area, int Mode, int maxFanin );
...
extern void            If_FaninCutComb( If_Man_t * p, int maxfanin, int maxfanout );
extern void            If_FanoutCutComb( If_Man_t * p, int maxfanin, int maxfanout );
